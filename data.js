const NORWAY_TRAVEL_DATA = {
  ...
  days: [
      ...
      itinerary: [
        {
          ...
          items: [
            { name: "PLAN PRINCIPAL: Senderismo panorámico y accesible (Ruta del lago Bygdin)", image: "assets/images/day3_jotunheimen.png", desc: "Ruta lineal de 8 km ida y vuelta sin apenas desnivel bordeando las aguas cristalinas del lago Bygdin. El terreno puede ser pedregoso o húmedo, por lo que se recomienda buen calzado de trekking y mochila con impermeable. Al finalizar, el broche de oro es disfrutar de un café caliente y gofres noruegos (vafler) con mermelada en la terraza panorámica del histórico Bygdin Høyfjellshotell.<br><br>📍 <b>Punto de inicio y fin:</b> La ruta empieza y acaba junto al histórico hotel <b>Bygdin Høyfjellshotell</b> (en la orilla oriental del lago Bygdin). Es un sendero lineal de ida y vuelta: se caminan 4 km bordeando la orilla norte del lago hacia el oeste hasta el punto de retorno panorámico y se regresa por el mismo camino de vuelta al hotel.<br>🅿️ <b>Dónde aparcar:</b> En el aparcamiento <b><a href='https://www.google.com/maps/search/?api=1&query=Bygdin+Hoyfjellshotell+Parkering' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>Bygdin Høyfjellshotell Parkering ↗</a></b>, un parking amplio y cómodo situado justo enfrente del hotel y al inicio del sendero (a 12 km / 15 min en coche al norte de Beitostølen por la Ruta 51)." },
      ...
      itinerary: [
        {
          ...
          items: [
            { name: "La Carretera Nacional de Rondane (Fv27)", image: "assets/images/image6.png", mapsUrl: "https://www.google.com/maps/search/?api=1&query=Rondane+Nasjonale+Turistveg", desc: "Ruta escénica que atraviesa la altiplanicie de Venabygdsfjellet, una meseta de alta montaña donde las cumbres de más de 2.000 metros dominan el horizonte. Un entorno salvaje, silencioso y alpino de tundra nórdica." },
    ...
    },
    {
      ...
      itinerary: [
        {
          ...
          items: [
            ...
            { name: "Cascada Vøringsfossen (Måbødalen)", image: "assets/images/glomnesfossen.png", mapsUrl: "https://www.google.com/maps/search/?api=1&query=Voringsfossen+Utsiktspunkt", desc: "Una de las caídas de agua más sobrecogedoras e imponentes de Noruega, con 180 metros de precipitación sobre el vertiginoso cañón de Måbødalen. Cuenta con un vanguardista conjunto de miradores y un puente de pasarelas de acero diseñado por Carl-Viggo Hølmebakk suspendido sobre el vacío.<br><br>📍 <b>Localización:</b> Cañón de Måbødalen (Carretera Rv7).<br>🅿️ <b>Dónde aparcar:</b> En el aparcamiento oficial <b><a href='https://www.google.com/maps/search/?api=1&query=Fossli+Hotel+Voringsfossen+Noruega' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>Vøringsfossen Parkering / Fossli ↗</a></b>." },
      ...
      cityGuide: {
        shopping: "<p style='display:flex; align-items:center; gap:0.75rem;'><img src='assets/images/image7.png' alt='Fossli Hotel' style='width:64px; height:64px; object-fit:cover; border-radius:8px; flex-shrink:0; box-shadow: 0 2px 6px rgba(0,0,0,0.15);' /><span>Cafetería y tienda de recuerdos en el <a href='https://www.google.com/maps/search/?api=1&query=Fossli+Hotel+Voringsfossen+Noruega' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>📍 Fossli Hotel ↗</a> (junto a <a href='https://www.google.com/maps/search/?api=1&query=Voringsfossen+Noruega' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>📍 Vøringsfossen ↗</a>).</span></p><p style='display:flex; align-items:center; gap:0.75rem;'><img src='assets/images/day2_valdres_stave_church.png' alt='Gol' style='width:64px; height:64px; object-fit:cover; border-radius:8px; flex-shrink:0; box-shadow: 0 2px 6px rgba(0,0,0,0.15);' /><span>Supermercados y cafeterías en <a href='https://www.google.com/maps/search/?api=1&query=Gol+Noruega' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>📍 Gol ↗</a>.</span></p>",
