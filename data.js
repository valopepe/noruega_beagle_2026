  ...
  days: [
      ...
      itinerary: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: "Iglesia de Madera de Hegge (Hegge Stavkirke)", image: "assets/images/day2_hegge_stave_church.png", mapsUrl: "https://www.google.com/maps/search/?api=1&query=Hegge+Stavkirke+Valdres+Noruega", desc: "Una de las iglesias de madera (stavkirke) medievales mejor conservadas de Noruega, construida hacia el año 1216. A tan solo 11 km de Beitostølen, en el valle de Valdres, esta joya del patrimonio arquitectónico noruego combina la tradición constructiva vikinga en madera con elementos románicos cristianos.<br><br>🏛️ <b>Historia y arquitectura:</b><br>Construida alrededor del año 1216, la iglesia de Hegge pertenece al tipo de stavkirke con cuatro postes centrales que sostienen la estructura. Sus muros están formados por tablones verticales de madera ensamblados con maestría. Destaca la puerta norte original del siglo XIII, ricamente tallada con motivos entrelazados de raíz nórdica, y los característicos remates en forma de cabeza de dragón en los vértices del tejado, herencia directa de la tradición vikinga.<br><br>📍 <b>Localización:</b> Øystre Slidre, Valdres (Oppland). A 11 km de Beitostølen por la carretera Fv51.<br>🅿️ <b>Dónde aparcar:</b> Aparcamiento gratuito junto a la iglesia en <a href='https://www.google.com/maps/search/?api=1&query=Hegge+Stavkirke+Valdres+Noruega' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>Hegge Stavkirke ↗</a>.<br>🕐 <b>Horario de verano:</b> Abierta al público en julio y agosto (consultar horario exacto en el panel informativo de la entrada).<br>💶 <b>Entrada:</b> Gratuita o donativo voluntario." }
          ]
        },
        {
      ...
      itinerary: [
        {
          ...
          items: [
            ...
            { name: "Alternativa Ocio: Beitostølen Sommerpark", image: "assets/images/hovi_cabins.png", mapsUrl: "https://www.google.com/maps/search/?api=1&query=Beitostolen+Sommerpark", desc: "El parque de verano del resort de Beitostølen es la atracción estrella para pasar la tarde. Cuenta con actividades divertidas diseñadas tanto para adultos como para grupos de amigos:<br><br>🛷 <b>Bobsleigh de Verano (Sommerakebakke):</b><br>Sin duda la atracción más divertida y adictiva del parque. Subís en telesilla hasta la cima y bajáis en trineo individual con freno propio por la pista de acero sobre las antiguas pistas de esquí. ¡Se puede repetir tantas veces como queráis con el pase de día!<br><br>🎫 <b>Precios:</b><br>• <b>Pase de Día completo (Dagspass):</b> ≈ 399 NOK (~34-35 €) por persona — incluye Bobsleigh, Karts de montaña y telesilla panorámico sin límite de viajes. La opción más rentable si pasáis la tarde entera.<br>• <b>Viaje individual:</b> 70-80 NOK (~6-7 €) por bajada — ideal si solo queréis probar una vez.<br><br>🏎️ <b>Karts de Montaña (Olabilløypa):</b><br>Karts sin motor que se lanzan cuesta abajo por un emocionante circuito asfaltado. Actividad perfecta para competir entre los cuatro amigos.<br><br>🚡 <b>Telesilla Panorámico (Bitihornexpressen):</b><br>Subid en el remonte principal simplemente para disfrutar de las vistas aéreas del valle de Beitostølen y las montañas circundantes sin esfuerzo físico.<br><br>🐴 <b>Rutas a Caballo por la Montaña:</b><br>Empresas locales como <a href='https://www.google.com/maps/search/?api=1&query=Fjellrittet+Beitostolen' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>Fjellrittet ↗</a> y Myhre Gård organizan rutas guiadas con caballos islandeses — más pequeños, robustos y dóciles, perfectos aunque nunca hayáis montado.<br><br>🚶 <b>Cómo llegar desde Hovi Cabins:</b><br>• <b>A pie (Recomendado):</b> El Sommerpark está en la base del Beitostølen Skisenter, justo en el centro del pueblo (calle Bygdinvegen). Desde la puerta de la cabaña, estaréis en la base del telesilla en apenas <b>5-10 minutos caminando</b> — sin necesidad de coger el coche.<br>• <b>En coche:</b> Aparcamiento amplio y gratuito en la base de las pistas (<a href='https://www.google.com/maps/search/?api=1&query=Beitostolen+Skisenter+Parkering' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>Beitostølen Skisenter Parkering ↗</a>, dirección Bygdinvegen 3813).<br><br>Una vez en la base, veréis claramente el remonte principal <b>Bitihornexpressen</b> y las taquillas donde comprar los pases." }
          ]
        }
      ],
      cityGuide: {
    ...
    },
    {
      ...
      cityGuide: {
        ...
        eating: "<p><a href='https://www.google.com/maps/search/?api=1&query=Stryn+Kaffebar+Vertshus+Noruega' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>📍 Stryn Kaffebar &amp; Vertshus ↗</a>: Un lugar acogedor con ambiente muy local. Tienen ensaladas generosas, sopas del día y opciones de pizzas o sándwiches (≈ 200-350 NOK por persona).</p><p><a href='https://www.google.com/maps/search/?api=1&query=Brasserie+Posthuset+Stryn+Noruega' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>📍 Brasserie Posthuset ↗</a>: Menú moderno con platos de pasta o risottos vegetarianos (≈ 300-450 NOK por persona).</p>",
        drinks: "<p><a href='https://www.google.com/maps/search/?api=1&query=Hotel+Raftevold+Hornindal+Noruega' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>📍 Hotel Raftevold Bar ↗</a>: Bar con vistas al lago Hornindalsvatnet, ideal para cervezas artesanas locales o vino (≈ 90-130 NOK por bebida).</p><p><a href='https://www.google.com/maps/search/?api=1&query=Visnes+Hotel+Stryn+Noruega' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>📍 Visnes Hotel ↗</a>: Hotel histórico en Stryn con un encanto especial (≈ 100-140 NOK por copa).</p>",
        whatToSee: "<p style='display:flex; align-items:center; gap:0.75rem;'><img src='assets/images/hornindalsvatnet.png' alt='Lago Hornindalsvatnet' style='width:64px; height:64px; object-fit:cover; border-radius:8px; flex-shrink:0; box-shadow: 0 2px 6px rgba(0,0,0,0.15);' /><span><a href='https://www.google.com/maps/search/?api=1&query=Hornindalsvatnet+Noruega' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>📍 Lago Hornindalsvatnet ↗</a> — Como estáis alojados justo a sus orillas, aprovechad para pasear. Es el lago más profundo de Europa (514 metros). Sus aguas son extremadamente claras y tienen un color azul intenso que es digno de ver.</span></p><p style='display:flex; align-items:center; gap:0.75rem;'><img src='assets/images/jostedalsbreen.png' alt='Glaciar Jostedalsbreen' style='width:64px; height:64px; object-fit:cover; border-radius:8px; flex-shrink:0; box-shadow: 0 2px 6px rgba(0,0,0,0.15);' /><span><a href='https://www.google.com/maps/search/?api=1&query=Jostedalsbreen+Noruega' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>📍 Glaciar Jostedalsbreen ↗</a> — El glaciar continental más grande de Europa. Podéis visitar el centro de interpretación cerca de Stryn para aprender sobre su formación, una experiencia cultural y educativa muy interesante.</span></p><p style='display:flex; align-items:center; gap:0.75rem;'><img src='assets/images/gamle_strynefjellsvegen.png' alt='Carretera panorámica Gamle Strynefjellsvegen' style='width:64px; height:64px; object-fit:cover; border-radius:8px; flex-shrink:0; box-shadow: 0 2px 6px rgba(0,0,0,0.15);' /><span><a href='https://www.google.com/maps/search/?api=1&query=Gamle+Strynefjellsvegen+Noruega' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>📍 Carretera panorámica Gamle Strynefjellsvegen ↗</a> — Si tenéis tiempo extra al atardecer, coged esta carretera histórica. Es una vía antigua de piedra que atraviesa montañas y cascadas.</span></p><p style='display:flex; align-items:center; gap:0.75rem;'><img src='assets/images/glomnesfossen.png' alt='Cascada Glomnesfossen' style='width:64px; height:64px; object-fit:cover; border-radius:8px; flex-shrink:0; box-shadow: 0 2px 6px rgba(0,0,0,0.15);' /><span><a href='https://www.google.com/maps/search/?api=1&query=Glomnesfossen+Noruega' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>📍 Cascada Glomnesfossen ↗</a> — Una impresionante caída de agua que se puede ver desde la carretera al conducir por el valle de Oppstryn. Es una de las paradas obligatorias para los amantes de la fotografía.</span></p>",
      },
      tips: [
        "⏱️ Flexibilidad con los tiempos: si os entretenéis haciendo fotos en cada curva de Rondane (¡es difícil evitarlo!), podéis recortar la visita al museo de minas de Folldal y verlo solo desde el exterior para recuperar el horario sin renunciar a lo imprescindible.",
        "🥗 Aprovisionamiento: es un día largo de coche. Preparad snacks suficientes en el SPAR de Beitostølen antes de salir, especialmente para vuestra acompañante vegetariana — los pequeños kioscos de carretera de montaña suelen tener solo bocadillos de carne o perritos. ¡Un buen aprovisionamiento os salvará el día!",
      ...
      itinerary: [
        {
          ...
          items: [
            ...
            { name: "Paseo por Flåm", image: "assets/images/day6_flam_village.png", mapsUrl: "https://www.google.com/maps/search/?api=1&query=Flam+Village+Norway", desc: "Trayecto en coche de 20 minutos desde Gudvangen a Flåm atravesando el túnel de Gudvanga. Desde las 15:30 hasta las 18:25 (embarque en el tren) tenéis tiempo para explorar este encantador pueblo a orillas del Aurlandsfjord. Aquí tenéis todo lo que podéis hacer:<br><br>🍺 <b>Ægir BrewPub (Recomendado para comer):</b><br>La opción estrella para el almuerzo tardío en Flåm. Una cervecería artesanal con ambiente vikingo excepcional, situada junto al puerto. Su arquitectura recuerda a un salón nórdico medieval con madera, fuego y cálida iluminación. Sirven pizzas de masa madre, sopas del día y platos nórdicos con opciones vegetarianas, todo acompañado de sus cervezas artesanas de elaboración propia. Precio aproximado: 250-400 NOK por persona. Muy recomendable reservar mesa con antelación o llegar pronto.<br><br>🚂 <b>Museo del Ferrocarril de Flåm (Flåm Rallarmuseet):</b><br>Situado en la misma estación, junto al punto de embarque del tren. Exposición gratuita que narra la historia y la ingeniería extraordinaria de la construcción de la línea Flåmsbana entre 1923 y 1940, con maquetas, fotos históricas y herramientas originales de los trabajadores (rallare). Perfecto para los 30 minutos de espera antes de subir al tren.<br><br>🏔️ <b>Mirador de Stegastein (alternativa o visita en coche):</b><br>A 5 km de Flåm por la carretera de montaña Fv243. Una pasarela de madera y vidrio que sobresale 30 metros al vacío a 650 metros sobre el Aurlandsfjord, con vistas de vértigo sobre el fiordo y el pueblo. Si tenéis coche y energía, es la parada fotográfica más impresionante de la zona. Tiempo estimado: 45-60 min ida y vuelta desde Flåm.<br><br>⛵ <b>Flåm Marina y Puerto:</b><br>Paseod por el animado muelle del pueblo, rodeado de veleros y barcas de pesca. El ambiente es muy agradable al llegar los cruceros y el ferry del fiordo. Hay pequeñas tiendas de artesanía noruega, recuerdos y heladerías junto al agua.<br><br>🛍️ <b>Tiendas de artesanía:</b><br>En la calle principal de Flåm encontraréis varias tiendas con productos noruegos de calidad: jerseys de lana, trolls artesanales, productos locales de arándano y salmón ahumado envasado, ideales como recuerdos.<br><br>📍 <b>Localización:</b> Puerto de Flåm, Aurlandsfjord.<br>🅿️ <b>Dónde aparcar:</b> En el aparcamiento principal <a href='https://www.google.com/maps/search/?api=1&query=Flam+Stasjon+Parkering' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>Flåm Stasjon Parkering ↗</a>, al lado de la estación y el puerto (de pago, tarifas por horas). Dejad el coche aquí antes de embarcar en el tren a las 18:25." },
    ...
    },
    {
      ...
      travelTimes: [
        { from: "Comfort Hotel Grand Central (Estación)", to: "Muelle Rådhusbrygge 3 (Puerto)", desc: "≈ 1.2 km · 15 min paseo a pie por el centro", icon: "🚶" },
        { from: "Muelle Rådhusbrygge", to: "Península de los Museos (Bygdøy)", desc: "≈ 3 km · 15 min en barco urbano / ferry municipal", icon: "🚢" },
        { from: "Península de Bygdøy", to: "Parque de Esculturas de Vigeland", desc: "≈ 4 km · 15 min en autobús línea 30", icon: "🚌" },
        { from: "Parque Vigeland", to: "Ópera de Oslo y Barrio de Bjørvika", desc: "≈ 3.5 km · 15 min en tranvía línea 12", icon: "🚃" }
      ],
      itinerary: [
        {
    ...
    },
    {
      ...
      travelTimes: [
        { from: "Comfort Hotel Grand Central (Estación)", to: "Terminal Aeropuerto Oslo (OSL)", desc: "≈ 47 km · 19 min en tren exprés Flytoget / 22 min en Vy", icon: "🚆" }
      ],
      itinerary: [
        {
